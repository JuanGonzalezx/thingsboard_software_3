...
public enum NotificationTargetType {
    ...
    PLATFORM_USERS(Set.of(NotificationDeliveryMethod.WEB, NotificationDeliveryMethod.EMAIL, NotificationDeliveryMethod.SMS, NotificationDeliveryMethod.MOBILE_APP, NotificationDeliveryMethod.TELEGRAM)),
