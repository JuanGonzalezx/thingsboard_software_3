...
public interface TelegramService {
    ...
    void sendMessage(TenantId tenantId, String token, String chatId, String message);

    void sendMessage(TenantId tenantId, String token, String chatId, String message, boolean parseMode);

    List<TelegramChat> getUpdates(TenantId tenantId, String token);
